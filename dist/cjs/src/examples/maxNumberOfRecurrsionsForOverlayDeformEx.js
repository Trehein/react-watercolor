...
exports.maxNumberOfRecurrsionsForOverlayDeformEx = void 0;
...
const shapesArray = new Array(numberOfShapesAndOverlays).fill(undefined).map((item, index) => {
    return Object.assign({ maxNumberOfRecurrsionsForOverlayDeform: index + 1, originX: (0, utils_1.calcEvenlySpacedNumbers)(svgWidth, index, numberOfShapesAndOverlays) }, stuffThatIsTheSameForEach);
});
exports.maxNumberOfRecurrsionsForOverlayDeformEx = {
    svgHeight: svgHeight,
    svgWidth: svgWidth,
