...
const generateCircleCoords = (numberOfPoints, radius, origin) => {
    ...
    return emptyArray.map((u, i) => {
        return (0, calcXYCoordsOfCircleWithAngle_1.calcXYCoordsOfCircleWithAngle)(angleInterval * i, radius, originX, originY);
    });
};
