...
const WaterDrop = (props) => {
    ...
    const initPoints = (0, utils_1.generateCircleCoords)(initPolygonPoints, initPolygonRadius, { originX: originX, originY: originY }, initRotationAngle).map((point) => {
        return { x: point.x, y: point.y };
    });
    const firstDeform = (0, utils_1.generateRandomPoints)(initPoints, maxRandomNumberForInitDeform, maxNumberOfRecurrsionsForInitDeform); // todo - add optional shape points here
